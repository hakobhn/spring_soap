 ...
 * 2019-08-23T07:37:09.680+04:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "UploadFile",
                  wsdlLocation = "file:/home/hakob/IdeaProjects/spring_boot_soap/src/main/resources/wsdl/UploadFile.wsdl",
...
public class UploadFile extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/hakob/IdeaProjects/spring_boot_soap/src/main/resources/wsdl/UploadFile.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UploadFile.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/hakob/IdeaProjects/spring_boot_soap/src/main/resources/wsdl/UploadFile.wsdl");
        }
        WSDL_LOCATION = url;
    }
